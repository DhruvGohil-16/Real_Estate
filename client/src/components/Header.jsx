  ...
  return (
    <header className='bg-gray-300 shadow-sm ty:fixed df:sticky'>
      ...
      <div className='flex justify-between max-w-6xl items-center  m-auto p-3'>
        ...
        <div className='flex'>
          <Link to='/buy'><div className='p-4 py-6 ty:hidden mdl:inline hover:border-t-4 hover:border-b-4 hover:border-b-black hover:border-t-gray-300 cursor-pointer'>Buy</div></Link>
          <Link to='/sell'><div className='p-4 py-6 ty:hidden  mdl:inline hover:border-t-4 hover:border-b-4 hover:border-b-black hover:border-t-gray-300 cursor-pointer'>Sell</div></Link>
          <Link to='/rent'><div className='p-4 py-6 ty:hidden mdl:inline hover:border-y-4 hover:border-b-4 hover:border-b-black hover:border-t-gray-300 cursor-pointer'>Rent</div></Link>
        </div>
        ...
        <div className='flex items-center justify-center'>
          ...
          <Link to='/'><div className='p-3 py-6 ty:hidden md:inline hover:border-y-4 hover:border-b-4 hover:border-b-black hover:border-t-gray-300 cursor-pointer'>Home</div></Link>
            ...
            : 
            (<>
              <Link to='/sign-in'><div className='p-3 py-6 ty:hidden md:inline hover:border-y-4 hover:border-b-4 hover:border-b-black hover:border-t-gray-300 hover:border-t-gray-400/60 cursor-pointer'>Login</div></Link>
